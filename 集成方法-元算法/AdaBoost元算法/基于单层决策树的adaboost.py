#-*- coding:utf-8 -*-
import numpy
from simpleDataPlot import plotData

#定义一些数据，和标签，并且返回数据和标签
def loadSimpData():
    #定义一些数据， 并且转换成矩阵
...
# plotData(datMat=loadSimpData()[0],classLabels=loadSimpData()[1])
...
if __name__ == "__main__":
    ...
    aggClassEst = adaClassify([0,0],classifierArr)
    print(aggClassEst)